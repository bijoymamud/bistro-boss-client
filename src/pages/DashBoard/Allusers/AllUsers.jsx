...
const AllUsers = () => {
  ...
  const handleMakeAdmin = (user) => {
    fetch(`http://localhost:5000/users/admin/${user._id}`, {
      ...
      .then(res => res.json())
      .then(data => {
        //! data take modify korar jnno check kora hocche
          ...
          <tbody>
            {
              ...
              >
                ...
                <td>
                  <button onClick={() => handleDelete(user)} className="btn btn-ghost bg-red-600 text-white hover:bg-white hover:text-red-500"><FaTrashAlt></FaTrashAlt></button>
                </td>
              </tr>)
            }
